...
class MedicationController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $medication = Medication::create([
            ...
            'packaging_unit' => !empty($validated['packaging_unit']) ? trim($validated['packaging_unit']) : null,
        ...
        if ($qty > 0) {
            StockMovement::create([
                ...
                'packaging_unit' => $medication->packaging_unit,
                'supplier' => 'Stock Initial (Création)',
                'user_id' => auth()->id(),
    ...
    public function update(Request $request, Medication $medication)
    {
        ...
        $medication->update([
            ...
            'dosage' => trim($validated['dosage']),
            'form' => trim($validated['form']),
            'packaging_unit' => !empty($validated['packaging_unit']) ? trim($validated['packaging_unit']) : $medication->packaging_unit,
            'category_id' => $categoryId,
            'min_threshold' => $threshold,
            'unit_price' => $validated['unit_price'],
            'purchase_price' => array_key_exists('purchase_price', $validated) ? $validated['purchase_price'] : $medication->purchase_price,
            'expiration_date' => $validated['expiration_date'] ?? null,
            'status' => $status,
        ]);

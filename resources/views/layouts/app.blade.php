...
<body class="bg-background text-on-background font-body-md antialiased min-h-screen flex">
    <!-- SideNavBar Admin -->
    <aside class="hidden md:flex flex-col h-screen fixed left-0 top-0 py-md space-y-sm overflow-y-auto w-64 bg-surface shadow-sm z-50 border-r border-outline-variant">
    ...
    <!-- Main Content Area -->
    <main class="flex-1 md:ml-64 flex flex-col min-h-screen bg-surface-bright">
        <!-- Desktop Header area -->
        <div class="hidden md:flex justify-between items-center px-lg py-md bg-surface-lowest border-b border-outline-variant sticky top-0 z-30">
